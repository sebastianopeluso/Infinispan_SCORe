...
public interface CommandsFactory {
    ...
    CommitCommand buildCommitCommand(GlobalTransaction gtx, SnapshotId commitSnapshotId);
    ...
    //Pedro
    /**
     * Builds a VoteCommand command for partial replication protocol
     * @param gtx global transaction associated with this abcast command
     * @param success true if the validation has success
     * @param keys the keys that was validated by this node
     * @return a VoteCommand
     */
    VoteCommand buildVoteCommand(GlobalTransaction gtx, boolean success, Set<Object> keys);

    AcquireValidationLocksCommand buildAcquireValidationLocksCommand(GlobalTransaction gtx, Set<Object> readSet, Set<Object> writeSet, SnapshotId snapshotId);
