...
public class CommitCommand extends AbstractTransactionBoundaryCommand {
    ...
    private SnapshotId commitSnapshotId;

    public CommitCommand(GlobalTransaction gtx) {
        this.globalTx = gtx;
    }

    public CommitCommand(GlobalTransaction gtx, SnapshotId commitSnapshotId) {
        this.globalTx = gtx;
    ...
    public SnapshotId getCommitSnapshotId() {
    ...
    public void setParameters(int commandId, Object[] args) {
        ...
        commitSnapshotId = (SnapshotId) args[2];
    }
}
