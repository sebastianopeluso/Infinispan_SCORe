...
public class ReplaceCommand extends AbstractDataWriteCommand {
        ...
        if (e != null) {
            if (ctx.isOriginLocal()) {
                ...
                if (oldValue == null || oldValue.equals(e.getValue())) {
                    ...
                    remoteWriteSkew = e.isRemoteWriteSkewNeeded();
    ...
    public Object[] getParameters() {
        return new Object[]{key, oldValue, newValue, remoteWriteSkew, lifespanMillis, maxIdleTimeMillis, flags};
    }
    ...
    public void setParameters(int commandId, Object[] parameters) {
        ...
        remoteWriteSkew = (Boolean) parameters[3];
