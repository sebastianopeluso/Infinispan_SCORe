...
public class DistributionInterceptor extends BaseRpcInterceptor {
    ...
    protected boolean needsRemoteGet(InvocationContext ctx, Object key, boolean retvalCheck) {
        CacheEntry entry;
     ...
     */
    protected Object remoteGetAndStoreInL1(InvocationContext ctx, Object key, boolean dmWasRehashingDuringLocalLookup, boolean isWrite) throws Throwable {
