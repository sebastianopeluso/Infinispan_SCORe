...
public interface DataContainer extends Iterable<InternalCacheEntry> {
    ...
    /*
     * ************ Interface for multiversion based serializability (added by Sebastiano) **************
     */


    InternalMVCCEntry get(Object k, SnapshotId snapshotId, boolean fromRemote);


    InternalMVCCEntry peek(Object k, SnapshotId snapshotId, boolean fromRemote);


    void put(Object k, Object v, long lifespan, long maxIdle, SnapshotId snapshotId);


    boolean containsKey(Object k, SnapshotId snapshotId);


    InternalCacheEntry remove(Object k, SnapshotId snapshotId);


    int size(SnapshotId snapshotId);


    void clear(SnapshotId snapshotId);


    Set<Object> keySet(SnapshotId snapshotId);


    Collection<Object> values(SnapshotId snapshotId);


    Set<InternalCacheEntry> entrySet(SnapshotId snapshotId);


    void purgeExpired(SnapshotId snapshotId);


    boolean validateKey(Object key, SnapshotId snapshotId);
}
