...
public class Configuration extends AbstractNamedCacheConfigurationBean {
    ...
    private void correctIsolationLevels() {
        ...
        switch (locking.isolationLevel) {
            ...
            case READ_UNCOMMITTED:
                ...
                break;
            //Pedro: this in no longer needed!
            /*case SERIALIZABLE:
    ...
    public void setReplicasPolicy(String policy){
        if (policy == null) {
            throw new ConfigurationException("replicasPolicy mode cannot be null", "ReplicasPolicyType");
        }
        this.clustering.setReplicasPolicy(ReplicasPolicyType.valueOf(uc(policy)));
    }

    public void setNumOfCertificationThreads(int value) {
        this.clustering.multiThreadCertification.setNumOfThreads(value);
    }

    public int getNumberOfCertificationThreads() {
        return clustering.multiThreadCertification.getNumOfThreads();
    }
    ...
    public boolean isTotalOrderFullReplication() {
        return getCacheMode().isReplicated() && this.clustering.isTotalOrderReplication();
    }

    public boolean isTotalOrderPartialReplication() {
        return getCacheMode().isDistributed() && this.clustering.isTotalOrderReplication();
    }

    public boolean isTotalOrderReplication() {
        return this.clustering.isTotalOrderReplication();
    }
    ...
    public static class ClusteringType extends AbstractFluentConfigurationBean implements ClusteringConfig {
        ...
        @XmlElement
        protected MultiThreadCertificationType multiThreadCertification = new MultiThreadCertificationType();
        ...
        public ClusteringType clone() throws CloneNotSupportedException {
            ...
            dolly.multiThreadCertification = (MultiThreadCertificationType) multiThreadCertification.clone();
            return dolly;
        }
        ...
        //PEDRO
        public boolean isTotalOrderReplication() {
            return this.replicasPolicy.mode == ReplicasPolicyMode.TOTAL_ORDER_REPLICATION;
        }
    }
    ...
    public static class ReplicasPolicyType extends AbstractNamedCacheConfigurationBean{
        ...
        public ReplicasPolicyType(){
            this.mode = ReplicasPolicyMode.PC; //default to 2-phase-commit
        }
    ...
    public static enum ReplicasPolicyMode{
        ...
        PASSIVE_REPLICATION,
        /*Total Order replication policy (broadcast for full replication and multicast for partial replication)*/
        TOTAL_ORDER_REPLICATION
    }

    @XmlAccessorType(XmlAccessType.PROPERTY)
    public static class MultiThreadCertificationType extends AbstractNamedCacheConfigurationBean{

        @ConfigurationDocRef(bean = Configuration.class, targetElement = "setNumOfCertificationThreads")
        protected int numOfThreads = 1; //single threaded by default

        public MultiThreadCertificationType(){
            this.numOfThreads = 1; //single threaded by default
        }
        ...
        public boolean equals(Object o) {
            ...
            MultiThreadCertificationType that = (MultiThreadCertificationType) o;
