...
public class DistributionManagerImpl implements DistributionManager {
    ...
    public InternalCacheEntry retrieveFromRemoteSource(Object key, InvocationContext ctx) throws Exception {
        ...
        if(ctx.isInTxScope()) {
            ...
            maxSnapshotToRead = ctx.getSnapshotId();


            get.setMaxSnapshotToRead(maxSnapshotToRead);
            get.setShouldAcquireSnapshotId(!((LocalTxInvocationContext)ctx).isFirstReadPerformed());
